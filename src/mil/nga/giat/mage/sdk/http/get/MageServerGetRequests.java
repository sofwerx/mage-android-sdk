...
public class MageServerGetRequests {
	...
	private static final String LOG_NAME = 
			MageServerGetRequests.class.getName();
	...
	public static Integer getFieldObservationLayerId(Context context) {
		...
		DefaultHttpClient httpclient = 
				HttpClientManager.getInstance(context).getHttpClient();
		HttpEntity entity = null;
		try {
			URL serverURL = new URL(PreferenceHelper.getInstance(context)
					.getValue(R.string.serverURLKey));
